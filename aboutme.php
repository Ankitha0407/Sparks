...
<body>
	<div  class="nv">
	<ul >
				<li class="active"><a  href="index.php" style="color:#b3b3b3" >Home</a></li> </ul></div>
			...
			<div id="main">
			    ...
			    <p> I'm persuing my third year Engineering in Jyothy Institute of Technology, I'm intrested in Web development and would like to work on projects related to Web. My skills are C , C++ , Python , sql , html , css , js.
			
			<br>Looking for an
organization which provides me the opportunity to improve
my skills and knowledge to growth along with the organization
objective.    <br><center><h3 style="margin-top:-30px;">Follow Me </h3></center>
			  </p>
